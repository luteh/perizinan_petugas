...
import '../../../../../permission_detail/permission_detail_args.dart';
...
class HomeMaps extends StatelessWidget {
            ...
            .map(
              (e) => Marker(
                ...
                infoWindow: InfoWindow(
                  ...
                  onTap: () => _onTapInfoWindowMarker(e),
                ),
              ),
            )
            .toSet());
  ...
  _onTapInfoWindowMarker(MonitoringEntity data) async {
    await NavigationUtil.pushNamed(PermissionDetailPage.routeName,
        arguments: PermissionDetailArgs(data.submissionId));
  }
}
